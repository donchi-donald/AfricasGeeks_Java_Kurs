...
public class Adressbuch {
	...
	public static void main(String[] args) {
		...
		String anrede, vorname,  nachname, straﬂe, hausnummer, plz,  ort;
		...
		do {
			...
			switch(antwort){
				case 1 :{
					...
					System.out.println("Geben Sie bitte  die Straﬂe: ");
					straﬂe = clavier.next();
					...
					ort = clavier.next();
					adresseEintragen(addressbuch, anrede,  vorname,  nachname, straﬂe,  hausnummer, plz, ort);
					break;
				}
				case 2 :{
					System.out.println("2: Bestehende Adresse bearbeiten");
					ausgabe(addressbuch);
					System.out.println("w‰hlen Sie bitte eine Adresse: ");
					...
					System.out.println("Geben Sie bitte  den Ort: ");
					ort = clavier.next();
					adresseBearbeiten(addressbuch, index, anrede,vorname,  nachname,straﬂe,  hausnummer,  plz, ort);
	...
	public static void adresseEintragen(String [][] addressbuch, String anrede, String vorname,  String nachname, String straﬂe, String hausnummer, String plz, String ort) {
		addressbuch[count][0]=anrede;
		addressbuch[count][1]=vorname;
		addressbuch[count][2]=nachname;
		addressbuch[count][3]=straﬂe;
	...
	public static void adresseBearbeiten(String [][] addressbuch, int index, String anrede, String vorname,  String nachname, String straﬂe, String hausnummer, String plz, String ort) {
		if(index>0 && index < count) {
			addressbuch[index-1][0]=anrede;
			addressbuch[index-1][1]=vorname;
			addressbuch[index-1][2]=nachname;
			addressbuch[index-1][3]=straﬂe;
